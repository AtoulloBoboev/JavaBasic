...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println("The size of school " + school + " is " + size);
	
		String school2 = "      Neotech Academy     ";
		int size2 = school2.length();
		System.out.println("The size of school " + school2 + " is " + size2);
		
		//toUpperCase() to LowerCase()
		String city = "FairFax";
		String newCity = city.toLowerCase(); //печатает с маленькими буквами
		...
		//isEmpty()
		String str = " "; //space is character
		boolean isEmp = str.isEmpty();
		System.out.println(isEmp);
		
		//trim()  //Обрезать ненужные пробели
		...
		System.out.println(size5); //печатает все с пробелами (29)
		
		String sent3 = sent2.trim(); //удаляет пробели (22)
